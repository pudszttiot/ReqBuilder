...
class HelpDialog(QDialog):
    def __init__(self, parent=None):
        ...
        help_text = """
            ...
            <p style="font-size: 20px; font-family: doergon, sans-serif; text-align: center;"><span style="color: #030303; background-color:#f5f5f5;">That's it!... Thank you for using <strong><span style="color: #94c7f7;">ReqBuilder!</span></strong></span></p>
...
class MenuBar(QMenuBar):
    def __init__(self, parent=None):
        ...
        self.setStyleSheet(open("styles.css").read())  # Load external CSS file
...
if __name__ == "__main__":
    ...
    app.setApplicationName("ReqBuilder")

    # Load resource files
    app.setWindowIcon(QIcon("../Images/builder1.png"))
