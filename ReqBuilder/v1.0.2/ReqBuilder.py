...
class PipreqsGUI(QMainWindow):
    def __init__(self):
        ...
        self.status_label = QLabel("Ready to run pipreqs")
    ...
    def run_pipreqs(self):
        ...
        if directory:
            ...
            self.status_label.setText("Running pipreqs... This may take a moment.")
    ...
    def show_success_message(self):
        self.status_label.setText("pipreqs completed successfully!")
    ...
    def clear_fields(self):
        ...
        self.status_label.setText("Ready to run pipreqs")
        self.progress_bar.setVisible(False)
